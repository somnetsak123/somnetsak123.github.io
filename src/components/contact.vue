      ...
      <div class="tw:grid tw:grid-cols  tw:text-white">
        <div class="tw:flex tw:flex-col">
          <div>
            ...
            <p class="tw:text-purple-100 tw:mb-8 tw:leading-relaxed">
              หากคุณมีโปรเจกต์ที่น่าสนใจ หรือต้องการความช่วยเหลือในการพัฒนาเว็บไซต์
              อย่าลังเลที่จะติดต่อมา ฉันยินดีที่จะรับฟังและช่วยเหลือคุณ
            </p>
