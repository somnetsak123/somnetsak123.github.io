  ...
  >
    ...
    <div class="tw:grid tw:grid-cols tw:text-black tw:dark:text-white">
     ...
     <div>
                    ...
                    <p class="tw:text-purple-100 tw:mb-8 tw:leading-relaxed">หากคุณมีโปรเจกต์ที่น่าสนใจ หรือต้องการความช่วยเหลือในการพัฒนาเว็บไซต์ อย่าลังเลที่จะติดต่อมา ฉันยินดีที่จะรับฟังและช่วยเหลือคุณ</p>
                    <div class="tw:grid tw:grid-cols-2 tw:gap-4">
                        <div class="tw:flex tw:items-center">
                            <div class="tw:w-12 tw:h-12 tw:bg-white tw:bg-opacity-20 tw:rounded-full tw:flex tw:items-center tw:justify-center q-mr-md">
                                📧
                            </div>
   ...
   <div class="tw:flex tw:items-center">
                            ...
                            <div class="tw:grid tw:grid-cols tw:items-center ">
                                <div class="tw:font-medium">Facebook</div>
                                <div class="tw:text-purple-200">Thanaphon Saengchan</div>
                            </div>
                        </div>
                        <div class="tw:flex tw:items-center">
                            <div class="tw:w-12 tw:h-12 tw:bg-white tw:bg-opacity-20 tw:rounded-full tw:flex tw:items-center tw:justify-center q-mr-md">
